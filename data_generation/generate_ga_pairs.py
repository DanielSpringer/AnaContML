    ...
    def calculate_gtau(
        ...
        for ub in np.unique(beta):
            ...
            if self.config['log_grid']==False:
                ...
                print('************* KERNEL OVERRIDE ************* ')
                if self.config['w_steps']==100:            
                    kernel = np.load(f'/gpfs/data/fs71925/dspringer1/Projects/InvPro/DRIVE/data/ctqmc_kernels_100/lambda_{int(beta[0]*self.w_max)}/kernel.npy')
                    v = np.load(f'/gpfs/data/fs71925/dspringer1/Projects/InvPro/DRIVE/data/ctqmc_kernels_100/lambda_{int(beta[0]*self.w_max)}/v.npy')
                    u = np.load(f'/gpfs/data/fs71925/dspringer1/Projects/InvPro/DRIVE/data/ctqmc_kernels_100/lambda_{int(beta[0]*self.w_max)}/u.npy')
                if self.config['w_steps']==1000:            
                    kernel = np.load(f'/gpfs/data/fs71925/dspringer1/Projects/InvPro/DRIVE/data/ctqmc_kernels_colab/lambda_{int(beta[0]*self.w_max)}/kernel.npy')
                    v = np.load(f'/gpfs/data/fs71925/dspringer1/Projects/InvPro/DRIVE/data/ctqmc_kernels_colab/lambda_{int(beta[0]*self.w_max)}/v.npy')
                    u = np.load(f'/gpfs/data/fs71925/dspringer1/Projects/InvPro/DRIVE/data/ctqmc_kernels_colab/lambda_{int(beta[0]*self.w_max)}/u.npy')
